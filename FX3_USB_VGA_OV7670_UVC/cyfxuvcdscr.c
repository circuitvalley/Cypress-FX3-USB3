...
#define UVC_HEIGHT                                    (unsigned int)483
#define CAM_FPS                                       30
#define VIDOE_PAYLOAD_SIZE                            (unsigned int)VIDEO_PACKET_SIZE-VIDOE_HEADER_SIZE
...
const uint8_t CyFxUSBHSConfigDscr[] =
    {
       ...
       /* Class specific Uncompressed VS Frame descriptor */
        ...
        0x01,                           /* Still image capture method 1 supported */
        0x80,0x02,                      /* Width in pixel: 640-QVGA */
        0xE0,0x01,                      /* Height in pixel 480-QVGA */
...
const uint8_t CyFxUSBSSConfigDscr[] =
    {
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
        ...
        WBVAL(UVC_WIDTH),                      /* Width in pixel: 160-QVGA */
        WBVAL(UVC_HEIGHT),                      /* Height in pixel 120-QVGA */
